...
\definecolor{subred}{rgb}{0,0,0}                  % 공개본: 리뷰 마커 검정 환원
...
\newcommand{\AppSection}[1]{%
  ...
  \phantomsection
  \addcontentsline{toc}{subsection}{\protect\numberline{\CurrentAppendixLetter.\arabic{appsection}}#1}%
...
\newcommand{\AppSubsection}[1]{%
  ...
  \phantomsection
  \addcontentsline{toc}{subsubsection}{\protect\numberline{\CurrentAppendixLetter.\arabic{appsection}.\arabic{appsubsection}}#1}%
...
\input{preamble_manual_numbering}
...
\input{front/01_cover}
\input{front/02_blank_page}
\input{front/03_titlepage}
\input{front/04_inner_title}
\input{front/05_approval}
\input{front/06_acknowledgements}
\input{front/07_kor_abstract}
\input{front/08_eng_abstract}
\clearpage
...
% ─── 본문 (5장 체계, 1차 심사 재편) ───
\input{chapters/ch1_introduction}  % 제1장 서론
\input{chapters/ch2_theory}        % 제2장 이론적 배경
\input{chapters/ch3_method}        % 제3장 연구 방법
\input{chapters/ch4_results}       % 제4장 연구 결과
\input{chapters/ch5_discussion}    % 제5장 논의 및 결론
