...
\syncr{합성 결과는 다음과 같다\chg{.} $O_{\text{APM}} = 0.933$, $O_{\text{SIEM}} = \erf{0.785}{0.635}$,
$O_{\text{raw}} = \erf{0.889}{0.844}$, $k_O = 0.72$, $U = \erf{0.55}{0.40}$로 산출되어
...
커버리지 부족을 식별하고, 성숙도 ``\erf{Managed → Optimized}{Defined → Managed}'' 이행 로드맵에
