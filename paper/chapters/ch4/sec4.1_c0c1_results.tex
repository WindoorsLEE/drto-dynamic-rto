...
$\DRTO$ 평균은 $5.115$시간이다.
관측성이 도입되면 $\DRTO$가 기본 복구 시간 $R_0$보다 체계적으로 단축됨을 의미하며,
...
H1의 검증 결과를 정리하면, \mrev{H1은 ``$\DRTO_{\text{C1}} \leq R_0 = 6.0$h가 100\% 표본에서 성립''을
...
크기 Cohen's $d = -1.180$로 \erf{매우 큰 효과}{대효과}에 해당되며 동시에 충족되어, H1은 채택된다.}
