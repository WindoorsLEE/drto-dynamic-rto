...
먼저 독자 여러분께 사과의 말씀을 드립니다. 학위논문을 최종 문서로 정리하여 옮기는
과정에서 일부 표기와 수치에 오류가 발생하였고, 그 오류가 포함된 판본이 dCollection에
등록·공개되었습니다. 등록본은 사후 수정이 불가능하기에, 이러한 오류를 바로잡은 내용을
본 공개 페이지에 올려 둡니다. 이용에 불편을 끼쳐 드린 점 진심으로 사과드립니다.
